...
public class FunctionDefinitionStatement extends Statement {
    ...
    public void compile(ByteCodeGenerator code) {
        ...
        for(String args: argumentNames){// iterate over parameter and make a slot for each.
            Integer i = code.createLocalStorageSlotFor(args);
        }
        for (Statement stmt: body){// then iterate over statements and compile
            stmt.compile(code);
        }
        ...
        if (getType() == CatscriptType.VOID){//if this is a void function add a return at the end
